...
#include <stdlib.h>/*Preproseccor Command to include standard Library file*/
int main()

{
    ...
    int options, totalCourses, , credits, totalCredits = 0 totalgradePoints = 0, totalmgpaPoints = 0;
